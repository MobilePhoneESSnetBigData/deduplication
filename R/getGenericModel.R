...
#'
#' @description Builds the generic HMM model using the emission probabilities 
...
#'
#' @param emissionProbs A matrix with the event location probabilities. The number 
...
#'
#' @param aprioriProb The apriori distribution for the HMM model. 
