#' Example of using \pkg{deduplication} package - the case of incompatibility
#' 
#' @description Example of using \pkg{deduplication} package - showing the case of 
#' incompatibility between the type of connection in the network and the emission 
#' model.
#'
#' @details This is an example of how to force the use of an emission model that 
...
#' this package: \code{checkConnections_step1()} and \code{checkConnections_step2()}. 
