...
#' the number of tiles in the grid and the number of columns equals the number of antennas. This matrix is obtained
#' by calling \code{getEmissionProbsJointModel}.
#'
