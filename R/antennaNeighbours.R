...
#'
#' @description Computes a list of pairs AntennaID1-AntennaID2 with nieghbouring antennas. Twa antennas are considered neighbours
#' if their coverage areas overlap (i.e. their intersection is not void).

#' @param coverarea a data.table object with two columns: 'antennaID' and 'cell'. The first column contains the ID of each antenna while
#' the second one contains an sp object that represents the coverage area of the corresponding antenna. It is obtained by calling
#' \code{readCells()} function.
#'
