...
#' \code{simulatedData} it could be a .csv file coming from the simulation software or from a real MNO.
#' In case the file comes from the simulation software it should contain following columns:
...
#' \code{time, deviceID, eventCode, antennaID, x, y, tile, obsVar}. \code{obsVar} stands for observed variable and
#' is a concatenation between the antenna ID and the event code.
#'
#'
#' @import data.table
#' @import stringr
